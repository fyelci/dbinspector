...
var dbinspectorApp = angular.module('dbinspectorApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'dbinspectorAppUtils', 'pascalprecht.translate', 'truncate']);
